...
class AdapterCustomSpinner(context: Context, resource: Int, private val objects: List<DataWithDescription>)
    : ArrayAdapter<DataWithDescription>(context, resource, objects) {
